...
public class MinaSidorPanel extends JPanel {
    ...
    private final JPanel kontoUppgifter;
    private MinaAnnonserPage minaAnnonser;
    private final JPanel bytLosenord;
    private final JPanel raderaKonto;
    ...
    private void makeMinaAnnonser() {
        minaAnnonser = new MinaAnnonserPage(width, height);

        cards.add(minaAnnonser, "MinaAnnonser");
    }

    private void makeKontoUppgifter() {
        JLabel kontoLabel = new JLabel("Konto");
        ...
        JLabel userNameLabel = new JLabel(userUserName);
        ...
        JLabel uppgifterLabel = new JLabel("Uppgifter");
        ...
        JLabel userNameLabel2 = new JLabel(userUserName);
        ...
        JButton changeUppgifterButton = new RoundedPanelExample.CircleBtn("Ändra uppgifter");
