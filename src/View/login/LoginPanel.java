...
public class LoginPanel extends JPanel {
    ...
    private Stack<JTextField> stack;

    private int width;
    private int height;

    public LoginPanel(int width, int height, Controller controller, LoginFrame frame) {
        super(null);
        thisPanel = this;
        this.frame = frame;
        ...
        this.setBackground(new Color(230,154,141,220));
    ...
    private void setUp() {
        lblTitle = new JLabel("Already have an account? Login");
    ...
    private void login(){
        ...
        if(str != null){
            controller.login(str, (ImageIcon) imageIcon.getIcon());
        } else {
